...
class MultipartStreamTest extends TestCase
{
    ...
    {
        $f1 = FnStream::decorate(\PhMessage\stream_for('foo'), [
            'getMetadata' => function () {
                return '/foo/bar.txt';
            }
        ]);

        $f2 = FnStream::decorate(\PhMessage\stream_for('baz'), [
            'getMetadata' => function () {
                return '/foo/baz.jpg';
            }
        ]);

        $f3 = FnStream::decorate(\PhMessage\stream_for('bar'), [
            'getMetadata' => function () {
                return '/foo/bar.gif';
            }
        ]);
